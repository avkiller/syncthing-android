...
REM 	Example:
REM 		com.fireworld.syncthing_v1.0.0.1_7d59e75.apk
REM 
title %~nx0
...
REM 
REM Variables.
SET TMP_DSC_ZIPFILE_FULLFN="%TEMP_OUTPUT_FOLDER%\%DATE:~-4%-%DATE:~-7,-5%-%DATE:~-10,-8%_com.fireworld.syncthing_v%VERSION_NAME%_%COMMIT_SHORT_HASH%.zip"
